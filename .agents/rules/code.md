...
- **Comments**: Code should be self-documenting. Use comments _only_ to explain the "why", not the "what" or "how".
...
- **Dependency Rule**: Dependencies must point _inwards_ towards the Domain. Use dependency injection to invert control.
