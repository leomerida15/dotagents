...
| 5 | **E2E: Regresión rutas de reglas** | Tests que verifiquen que los YAML de agente instalados viven solo en `.agents/.ai/rules/` (no copia duplicada en `.agents/rules/`). | 🟢 completo |
