...
## Status
- [ ] Documentación de ejecución E2E local y en modo debug.
- [ ] Script `test:e2e` referenciado y dependencias (build, etc.) documentadas.
- [ ] Opcional: job CI para E2E configurado y estable.
- [ ] status.md del roadmap actualizado cuando corresponda.
